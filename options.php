...
class MBFormPlugin {
	...
	public function add_plugin_page() {
		add_options_page ( _ ( 'Formulario de Motor de reservas' ), _ ( 'MB Form' ), 'manage_options', 'mbform-setting', array (
				$this,
				'create_admin_page' 
		) );
	}
...
<?php
	...
	public function page_init() {
		register_setting ( 'mbform_option_group', // Option group
...
;
		...
		add_settings_field ( 'hotelid', // ID
_ ( 'Id del hotel [HOTEL ID] ' ), // Title
array (
				$this,
				'mbform_admin_input_hotelid' 
		), // Callback
'mbform-setting', // Page
'setting_section_id' );
		
		add_settings_field ( 'urlmotor', _ ( 'Url del motor ' ), // Title
array (
				$this,
				'mbform_admin_input_urlmotor' 
		), 'mbform-setting', 'setting_section_id' );
		
		add_settings_field ( 'w_url', _ ( 'Url del nodo reservas' ), // Title
array (
				$this,
...
array (
				$this,
				'mbform_admin_input_noches' 
		), 'mbform-setting', 'setting_section_id' );
		
		/* traducciones */
		add_settings_field ( 'w_titulo', _ ( 'Titulo ' ), // Title
array (
				$this,
				'mbform_admin_input_tranlate_input' 
		), 'mbform-setting', 'setting_section_id', array (
		...
		add_settings_field ( 'w_titulo_confeccione', _ ( 'Subtitulo' ), // Title
array (
				$this,
				'mbform_admin_input_tranlate_input' 
		), 'mbform-setting', 'setting_section_id', array (
		...
		add_settings_field ( 'w_codigo_idioma', _ ( 'Codigo Idioma' ), // Title
array (
				$this,
				'mbform_admin_input_tranlate_input' 
		), 'mbform-setting', 'setting_section_id', array (
		...
		add_settings_field ( 'w_buscar', _ ( 'Boton Buscar' ), // Title
array (
				$this,
				'mbform_admin_input_tranlate_input' 
		), 'mbform-setting', 'setting_section_id', array (
		...
		add_settings_field ( 'w_llamenos', _ ( 'Boton Llamenos' ), // Title
array (
				$this,
				'mbform_admin_input_tranlate_input' 
		), 'mbform-setting', 'setting_section_id', array (
		...
		add_settings_field ( 'w_in', _ ( 'Campo In' ), // Title
array (
				$this,
				'mbform_admin_input_tranlate_input' 
		), 'mbform-setting', 'setting_section_id', array (
		...
		add_settings_field ( 'w_out', _ ( 'Campo Out' ), // Title
array (
				$this,
				'mbform_admin_input_tranlate_input' 
		), 'mbform-setting', 'setting_section_id', array (
